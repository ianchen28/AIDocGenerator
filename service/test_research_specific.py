#!/usr/bin/env python3
"""
测试 research.py 中的具体 f-string
"""


def test_research_prompt():
    """测试 research.py 中的 prompt"""
    print("=== 开始测试 research.py 中的 prompt ===")

    try:
        task_prompt = "请写一篇关于人工智能的文章，要求1000字"

        # 测试第一个 prompt（从 research.py 复制）
        prompt = f"""
...
if __name__ == "__main__":
    success = test_research_prompt()
    if success:
        print("🎉 research prompt 测试通过！")
    else:
        print("❌ research prompt 测试失败")
